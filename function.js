...
document.getElementById("clear-button").addEventListener("click", function() {
  document.getElementById("answer-box").value = ""; // Cancella il contenuto della textarea
  document.getElementById("char-counter").textContent = "Caratteri scritti: 0"; // Resetta il contatore
});
